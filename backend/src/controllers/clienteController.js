...
const createCliente = async (request, response) => {
    ...
    const createdCliente = await clientesModel.createCliente(request.body);
...
const updateCliente = async (request, response) => {
    ...
    await clientesModel.updateCliente(idcliente, request.body);
...
const deleteCliente = async (request, response) => {
    ...
    await clientesModel.deleteCliente(idcliente);
